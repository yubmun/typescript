...
// 숙제2
function 함수5(x?:string|number) :void{
...
// 숙제3
function 함수6(income:number, haveHouse:boolean, score:string) :string|void{
  let result:number = 0;
  result += income;
...
function 숙제2(x: string|number) :number | undefined {
  if(typeof x === "string"){
    return x.length;
  }
  if(typeof x === "number"){
...
function 숙제3(x:number, y:boolean, z:string) :string | undefined {
  let result = 0;
